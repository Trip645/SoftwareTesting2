...
describe('words Function for Webstore Testing Scenarios', () => {
  ...
  test('splits order details for review', () => {
    const orderDetails = 'Order 1892: Product Apple x 2, Product Blueberry x 1, Total: 25';

    // Using default pattern to split order details
    const orderWords = words(orderDetails);

    // Expected output: ['Order', '1892', 'Product', 'Apple', 'x', '2', 'Product', 'Blueberry', 'x', '1', 'Total', '25']
    expect(orderWords).toEqual(['Order', '1892', 'Product', 'Apple', 'x', '2', 'Product', 'Blueberry', 'x', '1', 'Total', '25']);
  });
